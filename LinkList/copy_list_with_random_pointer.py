...
# random pointer of the new nodes should point to new nodes in the copied list such that the 
...
class Solution:
    def copyRandomList(self, head: 'Node') -> 'Node':
      ...
      while trav:
        if trav.random:
          #new node's random is old node's random
          d[trav].random = d[trav.random]
